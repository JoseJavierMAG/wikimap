...
def get_pageviews(article, start_date, end_date):
    ...
    headers = {
        'User-Agent': 'PageViewRetriever/1.0 (your-email@example.com)'  # Replace with your email
    }
...
end_date = "20230930"  # End date (YYYYMMDD, last day of the month)
...
for article in articles:
    ...
    if pageviews_data:
        ...
        print(f"Error fetching data for {article}")
